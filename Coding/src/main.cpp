...
int main(int argc, char* argv[])
{
	...
	Texture tex_cb1 = Texture::generateCheckerboard(Eigen::Vector3f(0, 0, 1.0), Eigen::Vector3f(1.0, 1.0, 1.0));
	Texture tex_cb2 = Texture::generateCheckerboard(Eigen::Vector3f(0.7, 0, 1.0), Eigen::Vector3f(0.9, 0.0, 0.4), 5);
	Texture tex_cb3 = Texture::generateCheckerboard(Eigen::Vector3f(1.0, 1.0, 1.0), Eigen::Vector3f(0, 0, 0), 8);
	Texture tex_cb4 = Texture::generateCheckerboard(Eigen::Vector3f(0.3, 1.0, 0.4), Eigen::Vector3f(0.3, 0.7, 0.2));
